---
description: >-
  Prevent and Resolve Incidents With Autonomous Workers, Chat and Voice AI, and
  DEX
---
...
| ------------------------ | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **System Administrator** | ServiceNow Developer         | The person configuring the Zero Touch Service Desk. As admin you'll set up the Voice AI assistant, configure the L1 Service Desk AI Specialist, verify the DEX agent.                                                           |
